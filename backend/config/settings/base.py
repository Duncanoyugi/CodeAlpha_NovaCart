...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'config.authentication.GracefulJWTAuthentication',
    ),
...
MPESA_BUSINESS_SHORTCODE = os.getenv('MPESA_BUSINESS_SHORTCODE', MPESA_SHORTCODE)
...
MPESA_OAUTH_URL = os.getenv('MPESA_OAUTH_URL', '')
